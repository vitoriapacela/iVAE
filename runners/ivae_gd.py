...
#                 field_names = ['MCC', 'Loss', 'MCC_batch', 'Val_Loss', 'Val_MCC', 'MCS', 'MCS_p', 'Grad', 'Param_diff']
                field_names = ['MCC', 'Loss', 'MCC_batch', 'Val_Loss', 'Val_MCC', 'MCS', 'MCS_p', 'Grad', 'Param_diff', 'time']
                append_list_as_row(file_path, field_names)
            
#             row_contents = [perf_all, train_loss, train_perf, val_loss, val_perf, mix_perf, mix_mcs, grad_norm, norm_diff]
